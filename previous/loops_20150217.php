            ...
            if(isFileUrl($thumbnail) == true){ ?>
                <div class="col-xs-12 col-md-6">
                    ...
                    <!--h3 class="category_title">
                        <?php //$categories = get_the_category( $query->post->ID );?>
                        <a href="<?php //echo get_category_link( icl_object_id($categories[0]->term_id, 'category', false) ); ?>">
                            <?php //echo get_the_category_by_ID(icl_object_id($categories[0]->term_id, 'category', false)); ?>                     
                        </a>
                    </h3-->
                    <div class="image-holder">
                        <a href="<?php the_permalink(); ?>">
