...
<p>Gravatar es un servicio gratuito para propietari@s de web, desarrollador@s y usuari@s. Está incluido automáticamente en cada cuenta de wordpress.com y tiene el soporte de Automattic. </p>','makusi'); ?>
            ...
            <div class="table user-info-widget">
                <div class="row">
                 ...
                 <div class="row">
                    <div class="col-md-6">
                        <strong><?php echo __('Videos:','makusi'); ?></strong> 
                    </div>
                    <div class="col-md-6">   
                 ...
                 <div class="row">
                    <div class="col-md-6">
                        <strong><?php _e( 'Tu subscripción:', 'wpuf' ); ?></strong> 
                    </div>
                    <div class="col-md-6"> 
                        <?php //echo byteFormat($mem_count_str*1024*1024, 'GB',2); ?>
                        <?php echo $mem_count_str; ?> Gb <br />
                        <p style="font-size:0.8em; margin-bottom:0;"><a href=""><?php echo __('Aumenta tu capacidad.','makusi'); ?></a>
                    </div>
                 </div>
                <div class="row">
                    <div class="col-md-6">
            ...
            <div class="user-info-icons">
                ...
                <div class="user-info-icon col-md-4">
                    <a href="<?php echo site_url();?>/user-dashboard/">
                        <div class="user-icon-text"><?php echo __('Μis videos','makusi'); ?></div>
                ...
                <div class="user-info-icon col-md-4">
                    <a href="<?php echo site_url();?>/new-post/">
                        <div class="user-icon-text"><?php echo __('Subir un video','makusi'); ?></div>
                ...
                <div class="user-info-icon col-md-4">
                    <a id="remove_account" href="<?php echo site_url();?>/borrar-usuario/">
                        <div class="fa fa-times"></div>
                         <?php echo __('Darse de baja','makusi'); ?>
                    </a>
                    <div id="remove_account_dialog" title="<?php echo __('Borrar Cuenta','makusi'); ?>"><?php echo __('¿Estás seguro que quieres darte de baja y borrar tu cuenta?. Al hacer click sobre  "OK" tus datos y tus videos serán retirados','makusi'); ?></div>
                </div>
                <?php  } ?>
           </div>
            </div>
