...
$terminal = '1';
$order = date('ymdHis');
$amount = $_REQUEST['donation_value']*100;
$currency = '978';
$transactionType='0';
$urlMerchant = add_query_arg( array('action'=> 'donate_tpv_success','post_id'=>$_REQUEST['post_id']), home_url( '/donate' ) );
//$urlOk = home_url('/ok');
//$urlKo = home_url('/ko');
$producto='Donation';
    ...
    <div class="single-wrapper">
        <div class="content col-md-8 page-<?php echo $post->post_name; ?>">
            ...
            <?php if($_GET['action'] != 'wpuf_tpv_success'){ ?>
                ...
                <p><strong><?php echo __('PRECIO','makusi'); ?>:</strong> <?php echo $_REQUEST['donation_value']; ?> &euro;<br />
                <strong><?php echo __('Gastos de Gestión (20% Incluidos en la donación)','makusi'); ?>:</strong> <?php echo $_REQUEST['donation_value']*0.20; ?> &euro;<br />
                <strong><?php echo __('ID DE POST','makusi'); ?>:</strong> <?php echo $_REQUEST['post_id']; ?><br />
                <strong><?php echo __('TITULO DE POST','makusi'); ?>:</strong> <?php echo get_the_title( $_REQUEST['post_id'] ); ?> </p>
                ...
                <input type="hidden" name="Ds_Merchant_ProductionDescription" value="ID VIDEO:<?php echo $_REQUEST['post_id']; ?> - Autor:<?php echo $_REQUEST['author']; ?>" />
